...
import 'page7_days_report_copy_model.dart';
export 'page7_days_report_copy_model.dart';
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '디지털 밸런스가 좋아지고 있어요. 자기 전 소셜 미디어 사용을 줄여보세요.',
                                                maxLines: 3,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodySmall
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                wrapWithModel(
                                  model: _model.appUsageItemKrModel1,
                                  updateCallback: () => safeSetState(() {}),
                                  child: AppUsageItemKrWidget(
                                    app_name: 'YouTube',
                                    category: '엔터테인먼트',
                                    icon_name:
                                ...
                                wrapWithModel(
                                  model: _model.appUsageItemKrModel2,
                                  updateCallback: () => safeSetState(() {}),
                                  child: AppUsageItemKrWidget(
                                    app_name: 'Instagram',
                                    category: '소셜 미디어',
                                ...
                                wrapWithModel(
                                  model: _model.appUsageItemKrModel3,
                                  updateCallback: () => safeSetState(() {}),
                                  child: AppUsageItemKrWidget(
                                    app_name: 'WhatsApp',
                                    category: '커뮤니케이션',
                                    icon_name:
                                        'https://cdn.simpleicons.org/whatsapp/584738.svg',
                                    time: '5시간 50분',
                                  ),
                                ),
                                wrapWithModel(
                                  model: _model.appUsageItemKrModel4,
                                  updateCallback: () => safeSetState(() {}),
                                  child: AppUsageItemKrWidget(
                                    app_name: 'Netflix',
                                    category: '엔터테인먼트',
                                    icon_name:
                                        'https://cdn.simpleicons.org/netflix/584738.svg',
                                    time: '3시간 20분',
                                  ),
                                ),
                              ],
